    ...
    return res(
      ...
      ctx.json({
        ...
        data: {
          ...
          role: "user",
          token:
            "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJleHAiOjE2OTE1ODMyODQsImlkIjoyNywicm9sZSI6InVzZXIiLCJlbWFpbCI6ImhhcnNoYXZhcmRoYW4uc2l2YWRoYW5hbSsyM0BzdXJlaWZ5LmNvbSJ9.S08ssyESUWwRmtOYZZa-vmPCJg_0KmOAnmeZzlZ9FtM",
        },
      })
    );
  }),
